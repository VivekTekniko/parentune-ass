...
const Parentune = () => {
  const data = [
    {
      img: "https://s3-alpha-sig.figma.com/img/c551/eb69/adbf9cef9a30fd8e802c31d9bfaa7898?Expires=1724025600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=F-wt1jWQxHoQ595OcPD1ow7-nrS6hCONEB1V6ZV0AEKQMb8rD7xVxv8O9kdOHSVKuvg5dvU5knUMukls-x2Fhu33XwyA9G8VsUHSHbmmda0HrZ7vSXERnt4DvPl61ysndoHBxY3zUTSUpGx3UtFLWZ-irJVw5Xc4cHPDNnssTy0NpK~7mueWovWrceNj4gZy8LKUhI53fJaGXtuSLvTW8gTiWNfBHnNsEJP0del59u9ywxLdjsNSbC62EFDc0IMrHa5wVt-pv8ND18kkd1snoo32aACFgVkTIDoHo4-moPnmoUAV9IHut6A51BB-aeh3BJLQT7-FeMQYdFC~ESzSpg__",
      heading: "Neck Movement",
      text: "How to foaster gradual neck movement foe a baby",
      time: "2 min read",
    },
    {
      img: "https://s3-alpha-sig.figma.com/img/c551/eb69/adbf9cef9a30fd8e802c31d9bfaa7898?Expires=1724025600&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=F-wt1jWQxHoQ595OcPD1ow7-nrS6hCONEB1V6ZV0AEKQMb8rD7xVxv8O9kdOHSVKuvg5dvU5knUMukls-x2Fhu33XwyA9G8VsUHSHbmmda0HrZ7vSXERnt4DvPl61ysndoHBxY3zUTSUpGx3UtFLWZ-irJVw5Xc4cHPDNnssTy0NpK~7mueWovWrceNj4gZy8LKUhI53fJaGXtuSLvTW8gTiWNfBHnNsEJP0del59u9ywxLdjsNSbC62EFDc0IMrHa5wVt-pv8ND18kkd1snoo32aACFgVkTIDoHo4-moPnmoUAV9IHut6A51BB-aeh3BJLQT7-FeMQYdFC~ESzSpg__",
  ...
  return (
    <div className="">
      ...
      <div className="body">
        <h3 className="head-tag">Today's Focus</h3>
       <div className="card-div">
       {data.map((elem, id) => {
          return (
            <div className="slide-wrapper" key={id}>
              <img className="photo" src={elem.img} />
              <div className="content">
                <div className="first-head">
                  <h2>{elem.heading}</h2>
                  <p>
                    <CiClock2 className="" /> {elem.time}
                  </p>
                </div>

                <p style={{color:"#000"}}>{elem.text}</p>
              </div>
            </div>
          );
        })}
